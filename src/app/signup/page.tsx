        ...
        <div className="glass-panel glow-card rounded-2xl p-8 md:p-10 space-y-8">
          ...
          <form action={action} className="space-y-5">
            ...
            <div className="space-y-2">
              <label htmlFor="name" className="block text-[10px] font-mono tracking-[0.2em] uppercase text-zinc-500">
                Full Name
              </label>
              <input
                id="name"
              ...
              />
              {state?.errors?.name && (
                <p className="text-red-400 text-xs font-mono">{state.errors.name}</p>
              )}
            </div>
            ...
            {/* Confirm Password */}
            <div className="space-y-2">
              <label htmlFor="confirmPassword" className="block text-[10px] font-mono tracking-[0.2em] uppercase text-zinc-500">
                Confirm Password
              </label>
              <input
                id="confirmPassword"
              ...
              {state?.errors?.confirmPassword && (
                <p className="text-red-400 text-xs font-mono">{state.errors.confirmPassword}</p>
              )}
            </div>
